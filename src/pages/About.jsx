  ...
  return (
    <div>
      ...
      <section className="pt-32 pb-16 px-6 text-center">
        ...
        >
          <p className="text-[#C5A059] text-xs tracking-[0.4em] uppercase mb-4" style={{fontFamily:"'Lora', serif"}}>Who We Are</p>
          <h1 className="text-5xl md:text-6xl font-black tracking-tight" style={{fontFamily:"'Roboto Condensed', sans-serif"}}>Our Story</h1>
        </motion.div>
      </section>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.7 }}
          >
            <h2 className="text-3xl md:text-4xl font-black mb-6" style={{fontFamily:"'Roboto Condensed', sans-serif"}}>Where Tradition<br />Meets Excellence</h2>
            <p className="text-white/60 leading-relaxed mb-5" style={{fontFamily:"'Lora', serif"}}>
              Tip Top Barbershop was founded on a simple principle: that a quality haircut and genuine human connection should always go hand in hand. We're not just in the business ofcuts and shaves — we're in the business of building confidence.
            </p>
            <p className="text-white/60 leading-relaxed mb-5" style={{fontFamily:"'Lora', serif"}}>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <p className="text-[#C5A059] text-xs tracking-[0.4em] uppercase mb-4" style={{fontFamily:"'Lora', serif"}}>The Team</p>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight" style={{fontFamily:"'Roboto Condensed', sans-serif"}}>Meet Our Barbers</h2>
          </motion.div>
